...
import { SiMongodb, SiMysql, SiExpress, SiDjango, SiTailwindcss, SiPostgresql, SiPython, SiFirebase, SiGraphql, SiJenkins, SiTerraform, SiVisualstudiocode, SiPostman, SiVercel, SiGithub, SiLinux } from 'react-icons/si';
