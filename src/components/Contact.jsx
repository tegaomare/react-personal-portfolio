    ...
    <div name='contact' className='w-full h-screen bg-[#A6A2A2] flex justify-center items-center p-4'>
        <div className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8 flex flex-col justify-center w-full h-full items-center'>
                <p className='text-4xl font-bold inline border-b-4 border-[#11270B] text-black-500'>Contact</p>
            ...
            <button className='text-[#E6E8E6] border-2 hover:bg-[#11270B] hover:border-[#11270B] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </div>
    </div>
  )
}
